...
var Builder = /** @class */ (function () {
    function Builder(config, parents) {
    ...
    Builder.prototype.build = function (path, rebuild) {
        ...
        dependents.forEach(function (tmpl) {
            ...
            fileStr = _this.pasteTemplate(tmpl, fileStr);
        });
    ...
    Builder.prototype.setTemplateDependency = function (path, tmpl) {
        var parent = this.parents.get(tmpl.absPath());
        if (parent === undefined) {
    ...
    Builder.prototype.pasteTemplate = function (tmpl, page) {
        var templateStr = this.build(tmpl, false).toString();
    ...
    Builder.prototype.replaceTemplate = function (page) {
        ...
        if (layoutMatch) {
            var templateStr = this.build(Path_1.default.fromParts(this.templateDir.absPath(), layoutMatch[1]), false).toString();
